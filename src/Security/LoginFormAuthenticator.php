...
//            }, $password) // password = credentials
            ...
            [
                ...
                # Sf regarde si un checbox avec name="_remember_me" existe
                # enable => remember me auto pour tous les users, ne regarde plus les checkbox
    ...
    /**
     * IF API => return null => so that it continues to the controller
     */
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        // Après Login rediriger vers la page initiale
...
//    }
    ...
    /*
     * Si un user n'est pas authentifié => redirige vers login
